...
function wpsc_has_regions( $country ){
	return WPSC_Geography::country_has_regions( $country );
}
...
function wpsc_get_acceptable_countries() {
	...
	$country_data = WPSC_Geography::countries( true );
...
class wpsc_checkout {
	...
	function form_field() {
		...
		switch ( $this->checkout_item->type ) {
			...
			case "country":
				$output = WPSC_Geography_list( $this->checkout_item->id, false, $billing_country, $billing_region, $this->form_element_id() );
				break;

			case "delivery_country":
				$checkoutfields = true;
				$output = WPSC_Geography_list( $this->checkout_item->id, false, $delivery_country, $delivery_region, $this->form_element_id(), $checkoutfields );
				break;
