...
function wpsc_update_permalink_slugs() {
	...
	foreach ( $wpsc_pageurl_option as $option_key => $page_string ) {
		...
		// remove protocol from link, let the link take on the protocol of the enclosing page
		$the_new_link = preg_replace('#^https?://#', '//', $the_new_link);
//		$option_value = get_option( $option_key, '' );
//		if ( false !== stristr( $option_value, "https://" ) ) {
